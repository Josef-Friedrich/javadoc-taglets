 ...
 * @since 0.4.0
 */
public class DrawioTaglet implements Taglet
{
    private static final String NAME = "drawio";
    ...
    public String toString(List<? extends DocTree> tags, Element element)
    {
        ...
        String url = ((UnknownInlineTagTree) tags.get(0)).getContent().get(0)
                .toString().trim();
        return new DrawioIframe(url).toString();
    }
}
